...
Route::post('tasks/areas/add', 'TaskController@add');
Route::post('tasks/areas/remove', 'TaskController@remove');
Route::post('tasks/areas/location/update', 'TaskController@updateLocation');
